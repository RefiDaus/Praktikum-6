![gambar 1](screenshot/scr3.gif) <p>
...
<ul>
   ...
   <li>Fungsi Hapus(nama)</b></li>
   <li>Fungsi Ubah(nama)</b></li>
</ul>
<hr/>
...
### Maka akan ada pertanyaan seperti di bawah ini :
```javascript
(M)empilkan, (T)ambah, (U)bah), (H)apus, (K)eluar :
```
...
while True:
    ...
    header2=("BY : REFI DAUS NUR TRAMA")
    header3=("MENU PILIHAN UTAMA")
    print(header.center(97,"_"))
    print()
    print(header2.center(97,"="))
    print()
    print(header3.center(97,"_"))
    c = input("\n(M)empilkan, (T)ambah, (U)bah), (H)apus, (K)eluar : ")
